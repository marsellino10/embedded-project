...
//  Nokia5110_OutUDec(1234);
  ...
  Nokia5110_PrintBMP(d, 47, PlayerShip0, 0); // player ship middle bottom
  Nokia5110_PrintBMP(d, 47 - PLAYERH, Bunker0, 0);

  Nokia5110_PrintBMP(0, x, SmallEnemy10PointA, 0);
  Nokia5110_PrintBMP(16, x, SmallEnemy20PointA, 0);
  Nokia5110_PrintBMP(32, x, SmallEnemy20PointA, 0);
  Nokia5110_PrintBMP(48, x, SmallEnemy30PointA, 0);
  Nokia5110_PrintBMP(64, x, SmallEnemy30PointA, 0);
  Nokia5110_DisplayBuffer();     // draw buffer
}
